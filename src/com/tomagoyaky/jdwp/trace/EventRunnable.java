 ...
 * @author Robert Field
 */
public class EventRunnable extends Logger implements Runnable{
    ...
    EventRunnable(VirtualMachine vm, String[] excludes) {
        this.vm = vm;
    ...
    class ThreadTrace {
        ...
        void methodEntryEvent(MethodEntryEvent event)  {
        	...
        	String isNaticeStr =method.isNative() ? "Native" : "";
            try {
...
//    				if(methodName.startsWith("org.apache.http")){
    					logd(">>> [MethodEntryEvent] " + method.declaringType().name() + "." + method.name() + method.signature() + "\t" + isNaticeStr);
//    				}
    			}
        ...
        void fieldWatchEvent(ModificationWatchpointEvent event)  {
            ...
            logd("    " + field.name() + " = " + value);
        }

        void exceptionEvent(ExceptionEvent event) {
            logd("Exception: " + event.exception() +
...
//            vmDisconnectEvent((VMDisconnectEvent)event);
    ...
    public void vmDeathEvent(VMDeathEvent event) {
        vmDied = true;
        logd("-- The application exited --");
    }

    public void vmDisconnectEvent(VMDisconnectEvent event) {
        connected = false;
        if (!vmDied) {
            logd("-- The application has been disconnected --");
        }
    }
}
