...
public class ReverseApktool extends Executor {
	 ...
	 */
	public static boolean decompile(String jar_apktool, String apkFilePath, String dir_decompile) throws ExecuteException, IOException {
	 ...
	 */
	public static boolean bacompile(String jar_apktool, String dir_decompile, String apkFilePath) throws ExecuteException, IOException {
	 ...
	 */
	public static void DecodeAndroidManifest(String jar_AXMLPrinter, String androidManifest_xml, String androidManifest_txt) throws IOException {
	 ...
	 * */
	public static boolean baksmali(String jar_baksmali, String dir_decompile, String dexFilePath) throws ExecuteException, IOException {
	 ...
	 * @category 示例:{java -jar %ResourcePath%\baksmali-2.0.3.jar -a 17 %DEX% -o %DismDir%} 
	 * */
	public static boolean baksmali(String jar_baksmali, String dir_decompile, String dexFilePath, String cwd, int retval, OutputStream os) throws ExecuteException, IOException {
		return execute("java -jar \"" + jar_baksmali + "\" -a 19 \"" + dexFilePath + "\" -o \"" + dir_decompile + "\"" , 
				cwd, retval, os, 0);
	}
	 ...
	 * */
	public static boolean smali(String jar_smali, String dir_decompile, String targetDexFilePath) throws ExecuteException, IOException {
		return smali(jar_smali, dir_decompile, targetDexFilePath,
				System.getProperty("user.dir"), 0, System.out);
	}
	 ...
	 * @category 示例:{java -jar %ResourcePath%\smali-2.0.3.jar -a 17 -o %Output_DEX% %Smali_Dir%}
	 * */
	public static boolean smali(String jar_smali, String dir_decompile, String targetDexFilePath, String cwd, int retval, OutputStream os) throws ExecuteException, IOException {
	 ...
	 * @throws ExecuteException 
	 * */ 
	public static void baksmaliMultiDex(String jar_baksmali, ArrayList<String> dexFilePathList, String dir_workplace) throws ExecuteException, IOException {
	 ...
	 * @throws ExecuteException 
	 * */ 
	public static void baksmaliMultiDex(String jar_baksmali, ArrayList<String> dexFilePathList, String dir_workplace, String cwd, int retval, OutputStream os) throws ExecuteException, IOException {
		for (int i = 0; i < dexFilePathList.size(); i++) {
			String filePath = dexFilePathList.get(i);
			String dir_decompile = dir_workplace + File.separator + "disassembly_" + String.format("%02d", i + 1);
			execute("java -jar \"" + jar_baksmali + "\" -a 19 \"" + filePath + "\" -o \"" + dir_decompile + "\"" , 
